...
{foreach from=$quicktags key=qtfg item=qt}
	...
	">
		...
		<a title="{tr}special characters{/tr}" href="#" onclick="javascript:window.open('{$gBitLoc.KERNEL_PKG_URL}special_chars.php?textarea_id={$textarea_id}','','menubar=no,width=252,height=35');">
