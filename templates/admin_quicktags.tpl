		...
		<table class="data">
			...
			{foreach item=tag from=$quicktags.$format_guid}
				<tr class="{cycle values="odd,even" }">
					...
					<td class="actionicon">
					   <a href="{$smarty.const.QUICKTAGS_PKG_URL}admin/admin_quicktags.php?offset={$offset}&amp;sort_mode={$sort_mode}&amp;tag_id={$tag.tag_id}&amp;format_guid={$format_guid}">{biticon ipackage=liberty iname="edit" iexplain="edit"}</a>
					   <a href="{$smarty.const.QUICKTAGS_PKG_URL}admin/admin_quicktags.php?offset={$offset}&amp;sort_mode={$sort_mode}&amp;remove={$tag.tag_id}&amp;format_guid={$format_guid}">{biticon ipackage=liberty iname="delete" iexplain="remove"}</a>
					</td>
				</tr>
			{/foreach}
		</table>
